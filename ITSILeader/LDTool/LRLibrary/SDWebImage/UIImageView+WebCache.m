...
- (void)sd_setImageWithURL:(NSString *)urlString placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletionBlock)completedBlock {
    ...
    NSURL *url =[NSURL URLWithString:tempString2];
...
- (void)sd_setImageWithPreviousCachedImageWithURL:(NSString *)urlString placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletionBlock)completedBlock {
    //去汉字
    NSString *tempString = [urlString stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    //去汉字和替换空格处理
    NSString *tempString2 = [[NSString stringWithFormat:@"%@",tempString]
    ...
    [self sd_setImageWithURL:tempString2 placeholderImage:lastPreviousCachedImage ?: placeholder options:options progress:progressBlock completed:completedBlock];    
}
