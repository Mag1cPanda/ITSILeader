...
- (void)sd_setHighlightedImageWithURL:(NSString *)urlString options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletionBlock)completedBlock {
    ...
    if (urlString)
    {
        ...
        //去汉字和替换空格处理
        NSString *tempString2 = [[NSString stringWithFormat:@"%@",tempString]
                                stringByReplacingOccurrencesOfString:@" " withString:@"%20"];
        url =[NSURL URLWithString:tempString2];
...
- (void)setHighlightedImageWithURL:(NSString *)url options:(SDWebImageOptions)options {
    [self sd_setHighlightedImageWithURL:url options:options progress:nil completed:nil];
}

- (void)setHighlightedImageWithURL:(NSString *)url completed:(SDWebImageCompletedBlock)completedBlock {
...
- (void)setHighlightedImageWithURL:(NSString *)url options:(SDWebImageOptions)options completed:(SDWebImageCompletedBlock)completedBlock {
...
- (void)setHighlightedImageWithURL:(NSString *)url options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletedBlock)completedBlock {
